...
loaded_image = face_recognition.load_image_file("test_face.jpg")

known_image_encoding = face_recognition.face_encodings(loaded_image)[0]

best_face_distance = 1.0
best_face_image = None

print("finding ,It may take longer time...")
